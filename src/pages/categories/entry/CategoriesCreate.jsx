  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        console.error("API 400 Error Body:", errData);

        // DRF returns field-level errors: { name_en: ["msg"], logo: ["msg"] }
        // Flatten them into a readable string for the snackbar
        const extractMessage = (data) => {
          if (!data || typeof data !== 'object') return "Failed to create category";
          ...
          return fieldErrors || "Failed to create category";
        };
